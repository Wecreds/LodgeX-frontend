<template>
  <div
    class="fixed bg-black opacity-50 min-h-screen w-screen z-40"
      ...
      >
        ...
        <div class="mt-6 flow-root">
          <div class="-my-6 divide-y divide-gray-500/10">
            ...
            <div class="py-6">
              <a
                class="-mx-3 block rounded-lg px-3 py-2.5 text-base/7 font-semibold text-rich-black hover:bg-gray-50"
                @click="loginComponentOpen = !loginComponentOpen"
                >Log in</a
              >
            </div>
