  ...
  <div class="m-12 p-12 flex">
    ...
    <transition name="fade" mode="out-in">
      <div
        v-if="step === 1"
        key="step1"
        class="w-full flex flex-col gap-4 bg-gray-100 p-4 shadow rounded-lg"
      >
        <div>
        ...
        <div class="flex flex-col gap-4">
          ...
          >
            <div>
              <label
                for="email"
                class="block text-xl/6 font-medium text-rich-black"
                >Email address</label
              >
              <input
                id="email"
      ...
      >
        ...
        <div class="flex flex-col gap-4">
          <form
            class="contents unset-0"
            action="#"
            method="POST"
            @submit.prevent="changePersonalInfo()"
          >
            <div class="flex gap-4 w-full">
              <div class="w-1/2 flex flex-col gap-1">
                ...
                <input
                  ...
                  :value="userPersonalInfo.birthDate"
                  class="block w-1/2 rounded-md border-0 py-1.5 px-2 text-rich-black shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary-color sm:text-sm/6 outline-none"
                />
              </div>
              <div class="w-1/2 flex flex-col gap-1">
                ...
                <NationalitySelectorComponent
                  v-model="userPersonalInfo.nationality"
                />
              </div>
            </div>
            <div class="flex gap-4 w-full">
              <div class="w-1/2 flex flex-col gap-1">
                ...
                <CountrySelectorComponent
                  v-model="userPersonalInfo.country"
                  class="w-1/2"
                />
              </div>
              <div class="w-1/2 flex flex-col gap-1">
                ...
                <StateSelectorComponent
                  :selectedCountry="userPersonalInfo.country"
                  v-model="userPersonalInfo.state"
                />
              </div>
            </div>
            <div class="flex gap-4 w-full">
              <div class="w-1/2 flex flex-col gap-1">
                ...
                <CitySelectorComponent
                  :selectedCountry="userPersonalInfo.country"
                  :selectedState="userPersonalInfo.state"
                  v-model="userPersonalInfo.city"
                />
              </div>
              <div class="w-1/2 flex flex-col gap-1">
                <label
      ...
      >
        ...
        <div class="text-2xl font-bold" v-if="bookings.length === 0">
        ...
        >
          ...
          <div
            v-for="availability in booking.room_availability"
            ...
            <div class="flex flex-col gap-2 mt-2">
              ...
              <div class="text-gray-600">
                <span class="font-semibold">Price per Day:</span> ${{
                  availability.room.price_by_day
                }}
              </div>
              <div class="text-gray-600">
                <span class="font-semibold">Beds:</span>
                {{ availability.room.single_beds }} Single,
      ...
      >
        ...
        <div class="flex flex-col gap-1">
          <form
            ...
            action="#"
            method="POST"
            @submit.prevent="changePassword(newPassword)"
          >
            <div class="flex flex-col w-1/3">
              <div class="flex items-center justify-between">
                <label
                  for="password"
                  class="block text-sm/6 font-bold text-rich-black"
                  >New password</label
                >
              </div>
              <div>
...
const changePersonalInfo = async () => {
  const {
    ...
    postalCode,
    streetAddress,
  } = userStore.userData.personal_info
  const isUnchanged =
