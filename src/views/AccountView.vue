  ...
  <div class="m-12 p-12 flex">
    ...
    <transition name="fade" mode="out-in">
        ...
        <div class="flex flex-col gap-4">
          <form class="space-y-6" action="#" method="POST" @submit.prevent="changeCredentials()">
            ...
            <div class="flex flex-row gap-4">
              ...
              <input id="telephone" name="telephone" type="text" required="" v-model="currentPassword" v-if="!editing"
      ...
      <div v-else-if="step === 2" key="step2" class="w-full flex flex-col gap-4 bg-gray-200 p-4">
        ...
        <div class="flex flex-col gap-4">
          <form class="unstyle-me" action="#" method="POST" @submit.prevent="changeCredentials()">
            <div class="flex gap-4 w-full">
              ...
              <div class="w-1/2 flex flex-col gap-1">
                ...
                <input id="nationality" name="nationality" type="text" required="" :readonly="!editing"
            ...
            <div class="flex gap-4 w-full">
              <div class="w-1/2 flex flex-col gap-1">
                ...
                <CountrySelectorComponent v-model="userPersonalInfo.country" />
              </div>
              <div class="w-1/2 flex flex-col gap-1">
                <label for="city" class="block text-xl/6 font-medium text-rich-black">City</label>
                <CitySelectorComponent :selectedCountry="userPersonalInfo.country" :selectedState="userPersonalInfo.state" v-model="userPersonalInfo.city"/>
              </div>
            </div>
            <div class="flex gap-4 w-full">
              <div class="w-1/2 flex flex-col gap-1">
...
onMounted(async () => {
  ...
  userPersonalInfo.value = {
    birthDate: userStore.userData.personal_info.birth_date,
    nationality: userStore.userData.personal_info.nationality,
    address: userStore.userData.personal_info.street_address,
    ...
    postalCode: userStore.userData.personal_info.postal_code,
    createdAt: userStore.userData.created_at,
  }
})
</script>
<style scoped>
